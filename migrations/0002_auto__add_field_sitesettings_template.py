...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SiteSettings.template'
        db.add_column(u'seo_sitesettings', 'template',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SiteSettings.template'
        db.delete_column(u'seo_sitesettings', 'template')
