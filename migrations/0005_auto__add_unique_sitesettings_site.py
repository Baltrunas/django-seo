...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SiteSettings', fields ['site']
        db.create_unique(u'seo_sitesettings', ['site_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'SiteSettings', fields ['site']
        db.delete_unique(u'seo_sitesettings', ['site_id'])
    ...
    models = {
        ...
        u'seo.sitesettings': {
            ...
            'site': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'settings'", 'unique': 'True', 'to': u"orm['sites.Site']"}),
